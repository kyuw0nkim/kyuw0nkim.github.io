...
Then, during my undergraduate, I attended a conference with funding from my department.  
I sat in on a session without expecting much, but it stayed with me.

It made me realize that research grows through small pieces of work; each study modest on its own, but together shaping something larger.
That was when I started to see research differently.

Teaching helps the students in front of me.  
Research, I felt, could help shape something a bit larger. Something that lasts longer and reaches further.

Only later did I learn that this way of thinking aligns with Design-Based Research,
that knowledge develops iteratively, through accumulation.

But at that time, I didn’t have the words for it.
I just knew that I wanted to be part of that process.
`,
