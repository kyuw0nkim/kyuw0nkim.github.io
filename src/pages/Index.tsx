  ...
  return <MainLayout showProfile>
      ...
      <section id="about" className="content-section">
        ...
        <p className="text-foreground leading-relaxed text-justify">
          ...
          Outside the lab, I enjoy listening to others' stories, tinkering with computers—especially through design—and watching Let’s Play videos. Meeting new people and hearing their unique perspectives always inspires me. If any of this resonates with you, please feel free to reach out via kyuwonkim95@ewha.ac.kr!
        </p>
      </section>
